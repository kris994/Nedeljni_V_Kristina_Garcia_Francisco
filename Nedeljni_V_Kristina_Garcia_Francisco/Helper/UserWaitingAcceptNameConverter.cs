...
namespace Nedeljni_V_Kristina_Garcia_Francisco.Helper
{
    ...
    /// </summary>
    class UserWaitingAcceptNameConverter : IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            List<tblRelationship> allPandingUsers = userData.GetAllWaitingToAcceptUsers(LoggedInUser.CurrentUser).ToList();
